...
import com.github.chathamabate.peru.charpos.CharPos;
...
public class TraceException extends Exception {
    ...
    public TraceException push(CharPos d, String msg) {
        return new TraceException(trace.prepend(LineException.lineEx(d, msg)));
    }
    ...
    public TraceException push(int l, int lp, String msg) {
        return new TraceException(trace.prepend(LineException.lineEx(l, lp, msg)));
    }
}
