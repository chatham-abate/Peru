...
import com.github.chathamabate.TestingUtil;
...
public class TestFAutomaton {
    ...
    Seq<DynamicTest> testDFANullConstructionErrors() {
        return TestingUtil.buildThrowTests(NullPointerException.class, DFA_NULL_ERRORS);
    }
    ...
    Seq<DynamicTest> testDFAIllegalArgErrors() {
        return TestingUtil.buildThrowTests(IllegalArgumentException.class, DFA_ILLEGAL_ARG_ERRORS);
    }
    ...
    Seq<DynamicTest> testDFAOutOfBoundsErrors() {
        return TestingUtil.buildThrowTests(IndexOutOfBoundsException.class, DFA_OUT_OF_B_ERRORS);
    }
    ...
    Seq<DynamicTest> testNFANullErrors() {
        return TestingUtil.buildThrowTests(NullPointerException.class, NFA_NULL_ERRORS);
    }
    ...
    Seq<DynamicTest> testNFAIllegalArgumentErrors() {
        return TestingUtil.buildThrowTests(IllegalArgumentException.class, NFA_ILLEGAL_ARG_ERRORS);
    }
    ...
    Seq<DynamicTest> testNFAOutOfBoundsErrors() {
        return TestingUtil.buildThrowTests(IndexOutOfBoundsException.class, NFA_OUT_OF_B_ERRORS);
    }
