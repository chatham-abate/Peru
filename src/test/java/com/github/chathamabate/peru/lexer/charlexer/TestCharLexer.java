...
import com.github.chathamabate.peru.lexer.DLexer;
...
public class TestCharLexer {
    ...
    private static final DFAutomaton<Character, CharType1, Function1<CharSimpleContext, EnumCharPos<TokenType1>>>
        ...
        return CharType1.OTHER;
            ...
            .withAcceptingState(1, c -> EnumCharPos.charPosEnum(c, TokenType1.WHITESPACE))
            .withAcceptingState(2, c -> EnumCharPos.charPosEnum(c, TokenType1.INT))
            .withAcceptingState(4, c -> EnumCharPos.charPosEnum(c, TokenType1.DOUBLE));
    ...
    private static final DFAutomaton<Character, CharType2, Function1<CharSimpleContext, EnumCharPos<TokenType2>>>
            ...
            .withAcceptingState(2, c -> EnumCharPos.charPosEnum(c, TokenType2.SHORT))
            .withAcceptingState(5, c -> EnumCharPos.charPosEnum(c, TokenType2.LONG));
    ...
    private static final Seq<Tuple2<String, EnumCharPos<TokenType1>>> EXPECTED1 = List.of(
            Tuple.of("123", EnumCharPos.charPosEnum(0, 0, TokenType1.INT)),
            Tuple.of(" \n ", EnumCharPos.charPosEnum(0, 3, TokenType1.WHITESPACE)),
            Tuple.of("456", EnumCharPos.charPosEnum(1, 1, TokenType1.INT)),
            Tuple.of(" ", EnumCharPos.charPosEnum(1, 4, TokenType1.WHITESPACE)),
            Tuple.of("12.34", EnumCharPos.charPosEnum(1, 5, TokenType1.DOUBLE)),
            Tuple.of("\n", EnumCharPos.charPosEnum(1, 10, TokenType1.WHITESPACE))
    );
    ...
    private static final Seq<Tuple2<String, EnumCharPos<TokenType2>>> EXPECTED2 = List.of(
            Tuple.of("ababc", EnumCharPos.charPosEnum(0, 0, TokenType2.LONG)),
            Tuple.of("ab", EnumCharPos.charPosEnum(0, 5, TokenType2.SHORT)),
            Tuple.of("ab", EnumCharPos.charPosEnum(0, 7, TokenType2.SHORT)),
            Tuple.of("ab", EnumCharPos.charPosEnum(0, 9, TokenType2.SHORT)),
            Tuple.of("ab", EnumCharPos.charPosEnum(0, 11, TokenType2.SHORT))
    );
